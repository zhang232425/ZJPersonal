...
@IBDesignable open class ActiveLabel: UILabel {
    ...
    fileprivate func textOrigin(inRect rect: CGRect) -> CGPoint {
        ...
        return .init(x: rect.origin.x, y: glyphOriginY)
    }
    ...
    fileprivate func addLinkAttribute(_ mutAttrString: NSMutableAttributedString) {
        ...
        for (type, elements) in activeElements {
            ...
            case .custom:
                ...
                attributes[.underlineStyle] = customUnderLineStyle[type]?.rawValue
            }
    ...
    fileprivate func updateAttributesWhenSelected(_ isSelected: Bool) {
        ...
        if isSelected {
            ...
            case .url, .email: selectedColor = URLSelectedColor ?? URLColor
            case .custom:
            ...
            case .url, .email: unselectedColor = URLColor
            case .custom: unselectedColor = customColor[selectedElement.type] ?? defaultCustomColor
            }
            attributes[.foregroundColor] = unselectedColor
        }
